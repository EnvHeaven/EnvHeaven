...
export interface CommandIntent {
    kind: "daemon" | "run" | "deploy" | "offiline-web-ui" | "version" | "ui" | "apply";
    subcommand?: "stop" | "restart" | "status" | "version";
    target?: SupportedTarget;
    rawArgs: string[];
    normalizedTokens: string[];
    artifactSelectors?: string[];
}
export type SupportedTarget = "default" | "local" | "local-01" | "development" | "development-01" | "beta" | "beta-01" | "production" | "production-01" | "fake-local" | "fake-local-01" | "install-revert" | "install-revert-01";
